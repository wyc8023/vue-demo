    ...
    <div class="content">
      <ul class="search-form clearfix">
        <li class="clearfix">
          <label>关键词</label>
          <div class="input">
            <el-input v-model="formInline.keyword" placeholder="设计师、业主姓名或手机号"></el-input>
          </div>
        </li>
        <li class="clearfix">
          <label>项目类型</label>
          <div class="input">
            <el-select v-model="formInline.classify" placeholder="请选择项目类型">
              <el-option label="全部" value="qb"></el-option>
              <el-option label="十一大促" value="yitongguo"></el-option>
              <el-option label="双十一" value="weitongguo"></el-option>
            </el-select>
          </div>
        </li>
