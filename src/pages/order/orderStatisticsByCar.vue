  ...
  <div>
        ...
        <li class="clearfix" style="margin-left: 0px;">
         ...
         <el-row>
          <div class="statistics_div">
            <div>共计订单:{{total}}条&nbsp;&nbsp;&nbsp;&nbsp;  已收款：{{payMoney}}元</div>
            </div>
        </el-row>
    </el-form>
    ...
    <el-table
        ...
        <el-table-column
         ...
         <el-table-column
                prop="createTime"
                label="订单创建时间"  width="180"  :formatter="dateFormat">
        </el-table-column>
        <el-table-column
                prop="payTime"
                label="支付时间" :formatter="dateFormat" width="180" >
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    AllSearch () {
      ...
      this.$services.order.orderIncomeList(param).then((resp) => {
